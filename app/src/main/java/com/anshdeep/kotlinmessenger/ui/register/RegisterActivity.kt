...
import com.anshdeep.kotlinmessenger.Fragment.MainActivity
...
class RegisterActivity : AppCompatActivity() {
        ...
        if (requestCode == 0 && resultCode == Activity.RESULT_OK && data != null) {
            ...
            contentResolver.query(selectedPhotoUri!!, filePathColumn, null, null, null)?.use {
                ...
                if (picturePath.contains("DCIM")) {
                    ...
                    Picasso.get().load(selectedPhotoUri).rotate(180f).into(selectphoto_imageview_register)
                    Picasso.get().load(selectedPhotoUri).rotate(90f).into(selectphoto_imageview_register)
                } else {
    ...
    private fun performRegistration() {
        ...
        if (selectedPhotoUri == null) {
            Toast.makeText(this, "Por favor seleccine una foto", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener {
                    ...
                    // else if successful
                    Log.d(TAG, "Usuario creado: ${it.result!!.user?.uid}")
                    uploadImageToFirebaseStorage()
                    startActivity( Intent(this, MainActivity::class.java))
                }
                .addOnFailureListener {
                    Log.d(TAG, "Falla, usuario no creado: ${it.message}")
        ...
        if (selectedPhotoUri == null) {
            ...
            ref.putFile(selectedPhotoUri!!)
                    .addOnSuccessListener {
                        Log.d(TAG, "Imagen cargada con exito: ${it.metadata?.path}")
                    ...
                    .addOnFailureListener {
                        Log.d(TAG, "Error al cargar imagen: ${it.message}")
                        loading_view.visibility = View.GONE
                        already_have_account_text_view.visibility = View.VISIBLE
                    }
        }
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String?) {
        ...
        ref.setValue(user)
                .addOnSuccessListener {
                    Log.d(TAG, "Finalmente guardado en base de datos Firebase")
                ...
                .addOnFailureListener {
                    Log.d(TAG, "Error al establecer valor: ${it.message}")
                    loading_view.visibility = View.GONE
                    already_have_account_text_view.visibility = View.VISIBLE
                }
    }
